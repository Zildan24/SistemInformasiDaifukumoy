...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const allNavItems = [
    { name: "Dashboard", href: "/", icon: <LayoutDashboard size={20} />, roles: ["owner"] },
    { name: "Analitik & Tren", href: "/analytics", icon: <BarChart3 size={20} />, roles: ["owner"] },
    { name: "Kelola Pesanan PO", href: "/approval", icon: <ClipboardCheck size={20} />, badge: pendingPOs > 0 ? pendingPOs : null, roles: ["admin"] },
    { name: "Stok Global", href: "/global-stock", icon: <Package size={20} />, roles: ["admin"] },
    ...
    { name: "Inventory", href: "/inventory", icon: <Package size={20} />, roles: ["admin"] },
    { name: "Stock", href: "/stock", icon: <PackageOpen size={20} />, roles: ["admin"] },
